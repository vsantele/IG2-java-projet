...
INSERT INTO booking(lastname, firstname, amount, is_paid, phone, birthdate, email, date, charity_code, session_id) VALUES ('Lucas', 'Pierre', 34.28, true, '0485/91.80.49','1981-11-25', 'Pierre42@gmail.com','2021-06-10', 'CHAR1', 2);
INSERT INTO booking(lastname, firstname, amount, is_paid, phone, birthdate, email, date, charity_code, session_id) VALUES ('Roy', 'Guy', 12.28, true, '0442/24.83.76','1973-06-9', 'Guy_Roy47@gmail.com','2021-05-24', 'YATB', 3);
INSERT INTO booking(lastname, firstname, amount, is_paid, phone, birthdate, email, date, charity_code, session_id) VALUES ('Marchand', 'Manassé', 39.98, true, '0460/84.78.45','2009-05-21', 'Manass_Marchand87@yahoo.fr','2021-06-02', 'CHAR1', 4);
INSERT INTO booking(lastname, firstname, amount, is_paid, phone, birthdate, email, date, charity_code, session_id) VALUES ('Faure', 'Théophile', 27.38, false, '0478/78.13.84','1978-07-12', 'Thophile.Faure27@gmail.com','2021-06-12', 'YATB', 5);
INSERT INTO booking(lastname, firstname, amount, is_paid, phone, birthdate, email, date, charity_code, session_id) VALUES ('Perez', 'Arnaud', 30.25, false, '0481/00.99.91','2001-03-10', 'Arnaud99@gmail.com','2021-06-14', 'CHAR1', 3);
INSERT INTO booking(lastname, firstname, amount, is_paid, phone, birthdate, email, date, charity_code, session_id) VALUES ('Meyer', 'Agnane', 19.43, true, '0495/58.57.67','1979-04-19', 'Agnane_Meyer67@yahoo.fr','2021-05-27', 'AVMP', 2);
